...
public class MyMenuBar extends JMenuBar
{
   ...
   private final class HilfAction extends AbstractAction
   {
      ...
      public void actionPerformed(ActionEvent arg0)
      {
         JOptionPane.showMessageDialog(getRootPane(),
               "[Original] \"KeyGen\" Created by: Hesse Dominik\n [RaffleGenerator] Created/Edited/Translated by: Alex Wang\nVersion:0.1");
      }
   }
   ...
   private final class InfoAction extends AbstractAction
   {
      ...
      {
         JOptionPane.showMessageDialog(getRootPane(),
               "1)Type donor's username into the \"Username\" section.\n"
                     + "2)Click \"Generate\".\n"
                     	+ "3)Copy the generated code to the excel sheet.");
      }
   }
